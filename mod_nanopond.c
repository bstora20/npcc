		...
		while ((pptr->energy)&&(!stop)) {
			...
			if (falseLoopDepth) {
				...
				*/
				...
				access_neg_used =
				(inst == 0x0 || inst == 0x1 || inst == 0x2 || inst == 0x3 || inst == 0x4 || inst == 0x5 || inst == 0x6 || inst == 0x7 || inst == 0x8 || inst == 0x9 || inst == 0xa || inst == 0xb || inst == 0xc || inst == 0xe|| inst == 0xf)*(access_pos_used)+
				((inst == 0xd)*(1));
